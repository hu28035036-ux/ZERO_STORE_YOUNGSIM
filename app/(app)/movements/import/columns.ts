...
export type PurchaseColumnKey = 'code' | 'name' | 'qty' | 'cost'
...
export const COLUMN_HINT: Record<PurchaseColumnKey, string> = {
  ...
  cost: '생략하면 지금 원가를 그대로 씁니다. 박스 해석 줄에서는 박스당 가격으로 봅니다',
}
